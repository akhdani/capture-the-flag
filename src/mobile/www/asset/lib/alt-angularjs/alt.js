var alt = angular.module('Alt', ['ngRoute']);
    ...
    function($locationProvider, $compileProvider, $controllerProvider, $filterProvider, $logProvider, $provide, $routeProvider, $httpProvider){
        ...
        alt.routing = function(){
            return {
                ...
                resolve: {
                    load: [
                        '$q', '$route', '$timeout', '$auth', '$log', '$api','$window', '$rootScope',
                        function ($q, $route, $timeout, $auth, $log, $api, $window, $rootScope){
...
// create auth service
alt.factory('$auth', ['$log', '$window', function($log, $window){
    // set default local data
